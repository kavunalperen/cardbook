...
//        }
        ...
        imageLoader=CardbookApp.getInstance().getImageLoader();
...
//                }
    ...
    public void logout(){
        ...
        try{
            ...
            Toast.makeText(getActivity(),"Hesab�n�z ba�ar�yla silindi.",Toast.LENGTH_LONG).show();
        }
        catch (Exception e){
            Toast.makeText(getActivity(),"Hata olu�tu; l�tfen daha sonra tekrar deneyin.",Toast.LENGTH_LONG).show();
        }
    ...
    public void onClick(View view) {
        ...
        if(view.getId()==R.id.btnProfilUpdate){
