...
//        tvCompanyName=(TextView)view.findViewById(R.id.tvCompanyName);
        ...
        navBarText.setText(company.getCompanyName()+getResources().getString(R.string.iletisim_header));
...
*/
    ...
    public void onRequestStart() {
        ...
        dialog.setMessage(getResources().getString(R.string.message_is_sending));
        dialog.show();
    }
    ...
    public void onRequestComplete(JSONObject result) {
        ...
        dialog.dismiss();
        Toast.makeText(getActivity(),getResources().getString(R.string.message_is_sent), Toast.LENGTH_LONG).show();
        etText.setText("");
        etSubject.setText("");
    ...
    public void onRequestError() {
        ...
        Toast.makeText(getActivity(),getResources().getString(R.string.error_during_message_sending), Toast.LENGTH_LONG).show();
        dialog.dismiss();
    }
    ...
    public void onClick(View view) {
        if(view==btnSend)
            ...
            try {
                startActivity(Intent.createChooser(i, getResources().getString(R.string.send_message)));
            } catch (android.content.ActivityNotFoundException ex) {
                Toast.makeText(getActivity(), getResources().getString(R.string.device_not_compatiple_for_message_sending), Toast.LENGTH_SHORT).show();
            }
        }
