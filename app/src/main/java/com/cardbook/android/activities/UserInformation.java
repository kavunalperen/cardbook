...
import com.cardbook.android.adapters.CountryListAdapter;
        ...
        ConnectionManager.postData(this, new RequestCallBack() {
            ...
            public void onRequestComplete(JSONObject result) {
                ...
                if(result.optString(ConnectionManager.RESULT_CODE).equals(ConnectionManager.RESULT_CODE_OK)){
                    ...
                    Toast.makeText(getApplicationContext(),getResources().getString(R.string.saved_info),Toast.LENGTH_LONG).show();
...
//                    user.setBarcodeUrl(result.optJSONObject(AppConstants.POST_DATA).optString(CardBookUser.BARCODE_URL));
                    ...
                    Toast.makeText(getApplicationContext(),getResources().getString(R.string.error)+result.optString(ConnectionManager.RESULT_MESSAGE),Toast.LENGTH_LONG).show();
            }
        ...
        },method, user.getUserInfoAsDict(this.getApplicationContext()));
    ...
    public void showDialog(){
        ...
        dialog.setTitle(getResources().getString(R.string.choiche_born_date));
        dialog.show();
...
//            mImageView.setImageBitmap(user.getProfilPhoto());
//            return;
//        }

        Log.i("addImage UserInfo: "+user.getProfilPhotoUrl());
        ImageLoader imageLoader=CardbookApp.getInstance().getImageLoader();
...
//        userImage.setImageBitmap(image);
    ...
    public void addGender(){
        ...
        gender.add(getResources().getString(R.string.choiche_sex));
    ...
    public void addCountry(final ArrayList<Country> countries,final int selection) {
        ...
        for(int i=0; i<countries.size();i++){
            if(i==0)
                item.add(getResources().getString(R.string.choiche_state));
    ...
    public void addCity(final ArrayList<City> cities, final int selection) {
        ...
        for(int i=0; i<cities.size();i++){
            if(i==0)
                item.add(getResources().getString(R.string.input_hint_last_city));
...
//            Log.i("Cities: "+cities.get(i).getName()+", "+cities.size());
    ...
    public void addCounty(ArrayList<County> countries, int selection) {
        ...
        for(int i=0; i<countries.size();i++){
            if(i==0)
                item.add(getResources().getString(R.string.input_hint_last_county));
            item.add(countries.get(i).getName());
//            Log.i("Contries: "+countries.get(i).getName()+", "+countries.size());
        }
...
//                        .setTitle("Hata")
//                        .setMessage("UygulamayÄ± daha sonra tekrar baÅŸlatÄ±n.")
