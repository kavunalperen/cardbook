...
//                    new PostDataOperation().execute(user);
        ...
        try {
            // Get tracker.
            ((CardbookApp)getApplication()).getTracker();
...
//            t.send(new HitBuilders.AppViewBuilder().build());
            ...
            Log.i("Analytics datas are sended");
        }catch (Exception e){
            Log.i("Error during send analytics data");
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        int requestC=(Object)requestCode!=null?requestCode:64206;
        int resultC=(Object)resultCode!=null?resultCode:-1;

        super.onActivityResult(requestC, resultC, data);

        if(userInformation==null)
            mSimpleFacebook.onActivityResult(this, requestC, resultC, data);
    }
    ...
    private OnLoginListener mOnLoginListener = new OnLoginListener() {
		...
		public void onFail(String arg0) {
			...
			toast(getResources().getString(R.string.fb_login_error)+ arg0);
		}
		...
		public void onThinking() {
            ...
            dialog.setMessage(getResources().getString(R.string.fb_login_thinking));
            dialog.show();
		...
		public void onNotAcceptingPermissions(Type arg0) {
			...
			toast(getResources().getString(R.string.fb_login_permissions_not_accepted));
            dialog.dismiss();
		...
		public void onLogin() {
			...
			mSimpleFacebook.getProfile(new OnProfileListener() {
				public void onComplete(Profile profile) {
					...
					toast(getResources().getString(R.string.fb_login_ok));
    ...
    public void openUserInformationActivity(){
        RequestCallBack callback= new RequestCallBack() {
            ...
            public void onRequestStart() {
                dialog.setMessage(getResources().getString(R.string.download_adress));
                dialog.show();
