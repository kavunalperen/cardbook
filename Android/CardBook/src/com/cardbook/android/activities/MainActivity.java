...
//                    new PostDataOperation().execute(user);
                    AppConstants.getCompanyList(MainActivity.this, false); // DevamÄ±nda diÄŸer bilgiler alÄ±ncak ve diÄŸar ekrana yÃ¶nelenecek.
                }
                else
		...
		public void onLogin() {
			...
			mSimpleFacebook.getProfile(new OnProfileListener() {
				public void onComplete(Profile profile) {
					...
					toast("Facebook giriþi tamamlandý.");
...
*/
    ...
    public class PostDataOperation  extends AsyncTask<CardBookUser, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog.setMessage("Bilgiler alýnýyor...");
            dialog.show();
        }
